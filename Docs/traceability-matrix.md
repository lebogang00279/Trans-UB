...
| **FR-05** | Reserve/order an Available listing. | **UC-05 Reserve an available listing** | StudentAccount (buyer); Listing; Order; OrderStatusChange; Notification; ReserveListingBoundary; ReserveListingControl | Confirm reservation: one Pending order is created, Listing Available -Reserved, duplicate/live second reservation is refused. |
